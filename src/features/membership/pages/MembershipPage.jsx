  ...
  useEffect(() => {
    const fetchPricing = async () => {
      try {
        ...
        const personalPlans = [
          { id: 'free', title: 'Free', subtitle: 'Perfect to get started', monthlyPrice: pricing.free?.monthly || 0, yearlyPrice: pricing.free?.yearly || 0, features: ['Up to 10 chats per month', 'Basic file upload (2 files)', 'File size limit: 5MB', 'Community support', 'Basic conversation history'], icon: Star, popular: false },
          { id: 'student', title: 'Student', subtitle: 'For students and learners', monthlyPrice: pricing.student?.monthly || 249, yearlyPrice: pricing.student?.yearly || 2499, features: ['Up to 100 chats per month', 'Upload up to 10 files', 'File size limit: 25MB', 'Priority support', 'Advanced conversation features', 'Export chat history'], icon: Zap, popular: true },
          { id: 'plus', title: 'Plus', subtitle: 'For power users', monthlyPrice: pricing.plus?.monthly || 999, yearlyPrice: pricing.plus?.yearly || 9999, features: ['Up to 500 chats per month', 'Upload up to 50 files', 'File size limit: 100MB', 'Premium support', 'Advanced AI features', 'Custom branding', 'API access'], icon: Crown, popular: false },
          { id: 'pro', title: 'Pro', subtitle: 'For professionals', monthlyPrice: pricing.pro?.monthly || 1999, yearlyPrice: pricing.pro?.yearly || 19999, features: ['Up to 1000 chats per month', 'Upload up to 250 files', 'File size limit: 250MB', 'Premium support', 'Advanced AI features', 'Custom branding', 'API access', 'Advanced analytics'], icon: Award, popular: false },
        ];
        const businessPlans = [
          { id: 'business', title: 'Business', subtitle: 'For teams and organizations', monthlyPrice: pricing.business?.monthly || 2499, yearlyPrice: pricing.business?.yearly || 24999, features: ['Unlimited chats', 'Unlimited file uploads', 'File size limit: 500MB', 'Dedicated support', 'Team management', 'Advanced permissions', 'Custom integrations', 'SLA guarantee'], icon: Shield, popular: false },
        ];
