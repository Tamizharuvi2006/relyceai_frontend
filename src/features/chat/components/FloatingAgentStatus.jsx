...
export const FloatingAgentStatus = ({ messages, isTyping }) => {
  ...
  const isWarning = meta?.agent_state === "repairing" || meta?.agent_state === "rolling_back" || meta?.agent_state === "awaiting_confirmation";
